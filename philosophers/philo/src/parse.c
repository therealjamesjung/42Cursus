...
int _init_table(t_table *table)
{
    ...
    table->m_log = (pthread_mutex_t *)malloc(sizeof(pthread_mutex_t));
    table->start = (pthread_mutex_t *)malloc(sizeof(pthread_mutex_t));
    ...
    while (++i < table->chair_cnt)
    {
        ...
        table->philo[i].m_eats = (pthread_mutex_t *)malloc(sizeof(pthread_mutex_t));
